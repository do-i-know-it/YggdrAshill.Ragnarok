...
{
    internal sealed class ActivateToInstantiateWithParameterList : IInstantiation
    {
        private readonly IActivation activation;
        private readonly IReadOnlyList<IParameter> parameterList;

        public ActivateToInstantiateWithParameterList(IActivation activation, IReadOnlyList<IParameter> parameterList)
        {
